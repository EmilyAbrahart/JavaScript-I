...
let index = inventory.findIndex(a => a.id === 33);
//console.log(index);
...
console.log(`The last car in the inventory is the ${lastCar.car_make} ${lastCar.car_model}.`);
...
let oldCars = [];
oldCars = carYears.filter(carAge => carAge < 2000);
console.log(oldCars.length); 

// ==== Challenge 6 ====
// A buyer is interested in seeing only BMW and Audi cars within the inventory.  Return an array that only contains BMW and Audi cars.  Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.
let BMWAndAudi = [];
BMWAndAudi = inventory.filter(x => x.car_make === "Audi" || x.car_make === "BMW");
